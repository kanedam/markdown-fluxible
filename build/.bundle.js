...
},{"./components/MarkdownApp.jsx":3,"./stores/MarkdownStore":6,"fluxible":10,"react":199}],3:[function(require,module,exports){
"use strict";
var React = require("react");
...
module.exports = React.createClass({
	...
	render: function render() {
		return React.createElement(
			"div",
			{ id: "editor" },
			React.createElement(MarkdownInput, { text: "# Hello" }),
			React.createElement(MarkdownItem, null)
		);
	}
});

},{"./MarkdownInput.jsx":4,"./MarkdownItem.jsx":5,"react":199}],4:[function(require,module,exports){
"use strict";
var React = require("react");
...
},{"../actions/MarkdownAction":1,"fluxible":10,"react":199}],5:[function(require,module,exports){
"use strict";
var React = require("react");
...
module.exports = React.createClass({
	...
	render: function render() {
		return React.createElement("div", { dangerouslySetInnerHTML: { __html: this.state.markedText } });
	},
...
},{"../stores/MarkdownStore":6,"fluxible":10,"react":199}],6:[function(require,module,exports){
"use strict";
...
var MarkdownStore = createStore({
	...
	getMarkedText: function getMarkedText() {
		return this.markedText;
	},

	updateMarkedText: function updateMarkedText(text) {
		if (text) {
...
},{"fluxible/addons":9,"marked":26}],7:[function(require,module,exports){
module.exports = require('dispatchr/utils/BaseStore');

},{"dispatchr/utils/BaseStore":22}],8:[function(require,module,exports){
module.exports = require('dispatchr/utils/createStore');

},{"dispatchr/utils/createStore":23}],9:[function(require,module,exports){
module.exports = {
    BaseStore: require('./BaseStore'),
    createStore: require('./createStore')
};

},{"./BaseStore":7,"./createStore":8}],10:[function(require,module,exports){
/**
...
},{"./lib/Fluxible":11,"./lib/FluxibleComponent":12,"./lib/FluxibleMixin":14,"object-assign":24}],11:[function(require,module,exports){
/**
 * Copyright 2014, Yahoo! Inc.
 * Copyrights licensed under the New BSD License. See the accompanying LICENSE file for terms.
 */
...
},{"./FluxibleContext":13,"async":15,"debug":16,"dispatchr":19,"react":199}],12:[function(require,module,exports){
...
},{"react/addons":27}],13:[function(require,module,exports){
/**
 * Copyright 2014, Yahoo! Inc.
 * Copyrights licensed under the New BSD License. See the accompanying LICENSE file for terms.
 */
...
},{"./FluxibleComponent":12,"async":15,"debug":16,"react":199,"setimmediate":25}],14:[function(require,module,exports){
/**
 * Copyright 2014, Yahoo! Inc.
 * Copyrights licensed under the New BSD License. See the accompanying LICENSE file for terms.
 */
...
},{"_process":202}],16:[function(require,module,exports){
